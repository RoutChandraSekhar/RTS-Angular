    ...
    if (1 === $(".material-design-hamburger__icon").length && document.querySelector(".material-design-hamburger__icon").addEventListener("click", function() {
        ...
        var e;
            ...
            this.parentNode.nextElementSibling.classList.toggle("menu--on"),
             // e = this.childNodes[1].classList, 
             //in the original template array value was 1, I turned it to zero
             e = this.childNodes[0].classList,
              e.contains("material-design-hamburger__icon--to-arrow") ? (e.remove("material-design-hamburger__icon--to-arrow"), 
              e.add("material-design-hamburger__icon--from-arrow")) : (e.remove("material-design-hamburger__icon--from-arrow"), 
              e.add("material-design-hamburger__icon--to-arrow"))
        }), 
        
        $(".fixed-sidebar .navigation-toggle a").removeClass("button-collapse"), 
        $(".fixed-sidebar .navigation-toggle a").addClass("reverse-icon"), $(".fixed-sidebar .navigation-toggle a").click(function() {
